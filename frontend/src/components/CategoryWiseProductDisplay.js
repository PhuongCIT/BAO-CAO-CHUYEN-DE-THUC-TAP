...
const CategroyWiseProductDisplay = ({ category, heading }) => {
  ...
  return (
    <div className="container mx-auto px-4 my-6 relative">
      ...
      {/* <div className="grid grid-cols-[repeat(auto-fit,minmax(100px,220px))] justify-between md:gap-3 overflow-x-scroll scrollbar-none transition-all"> */}
      <div
          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  className="w-full min-w-[180px]  md:min-w-[220px] max-w-[180px] md:max-w-[320px]  bg-white rounded-sm shadow gap"
                  onClick={scrollTop}
                >
